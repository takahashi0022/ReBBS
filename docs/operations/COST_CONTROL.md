...
## Amazon Bedrock (Claude 3 Haiku) 料金
...
| 項目 | トークン数 | コスト |
|------|-----------|--------|
| 入力（プロンプト + 過去投稿） | 約300 | $0.000075 |
| 出力（なんJ風短文） | 約50 | $0.0000625 |
| **合計** | **350** | **約$0.0001 (0.015円)** |
...
- 手動テスト: 50投稿
- 自動スレッド: 0（RSS無効）
= 50投稿/日 × $0.0001 = $0.005/日 (約0.75円/日)
月間: 約$0.15 (約22円/月)
```
...
- ユーザー生成: 100投稿
= 140投稿/日 × $0.0001 = $0.014/日 (約2.1円/日)
月間: 約$0.42 (約63円/月)
```
...
**Q: 最も安全な設定は？**
A: `DAILY_MAX_REQUESTS=50` で1日最大$0.005（約0.75円）に抑えられます。
